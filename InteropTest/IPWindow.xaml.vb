...
Public Class IPWindow
    ...
    Public Property FSWindow As FSMonTestWindow
        ...
        Set(ByVal value As FSMonTestWindow)
    ...
    Public Property CodeEx As CodeExplorer
        ...
        Set(ByVal value As CodeExplorer)
    ...
    Public Shared Function GetViewMenu(ByVal element As DependencyObject) As VirtualMenu
    ...
    Public Shared Sub SetViewMenu(ByVal element As DependencyObject, ByVal value As VirtualMenu)
        If element Is Nothing Then
            Throw New ArgumentNullException("element")
        End If
