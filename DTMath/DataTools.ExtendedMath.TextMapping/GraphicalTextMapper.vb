...
#Region "Protected Methods"
        ...
        Public Function RenderImage(Optional drawRectangles As Boolean = True) As System.Drawing.Bitmap
            ...
            _rendered = New Bitmap(x, y, PixelFormat.Format32bppArgb)
        ...
        Public Shared Sub RenderGrid( _
            ...
            pnX = New System.Drawing.Pen(ColorX, Thickness)
            pnY = New System.Drawing.Pen(ColorY, Thickness)
            ...
            For x = (GridX / 2) To cx Step GridX
            ...
            For y = (GridY / 2) To cy Step GridY
                If (GridType = GridLinesType.Dotted) Then
        ...
        Protected Function ScaleRect(rcIn As Rectangle) As Rectangle
            Return New Rectangle(rcIn.X * _Scale, rcIn.Y * _Scale, rcIn.Width * _Scale, rcIn.Height * _Scale)
        End Function
        ...
        Protected Function Calculate() As Rectangle()
            ...
            Dim mm As DataTools.Memory.MemPtr = bm.Scan0
            ...
            For x = 0 To cx - 1 Step (cx * 0.0375)

                For y = 0 To cy - 1 Step (cy * 0.0375)
...
refor:
        ...
        Protected Function CheckRect(rc As Rectangle, cx As Integer, cy As Integer, mm As MemPtr) As Boolean
            ...
            For y = rc.Top To rc.Bottom
                For x = rc.Left To rc.Right
                    ...
                    If mm.ByteAt(l) < 250 OrElse _
                       mm.ByteAt(l + 1) < 250 OrElse _
                       mm.ByteAt(l + 2) < 250 Then
