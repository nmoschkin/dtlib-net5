...
#Region "Hid Feature Codes"
        ...
        Public Function HidGetFeature(featureCode As Byte, ByRef result As Byte(), expectedSize As Integer) As Boolean
            ...
            Else
                HidGetFeature = True
                result = mm.GrabBytes(1, expectedSize)
            End If
        ...
        Public Function HidSetFeature(featureCode As Byte, value As Byte()) As Boolean
            ...
            If Not HidD_SetFeature(hfile, mm, mm.Length) Then
                HidSetFeature = False
            Else
                HidSetFeature = True
            End If
        ...
        Public Property HidManufacturer As String
            Get
                If _HidManufacturer Is Nothing Then
                    ...
                    Dim mm As MemPtr
                    mm.AllocZero(512)
                    HidD_GetManufacturerString(dev, mm, mm.Length)
                    _HidManufacturer = mm.GrabString(0)
                    mm.Free()
                    CloseHid(dev)
                End If
        ...
        Public Property SerialNumber As String
            Get
                If _SerialNumber Is Nothing Then
                    ...
                    Dim mm As MemPtr
                    mm.AllocZero(512)
                    HidD_GetSerialNumberString(dev, mm, mm.Length)
                    _SerialNumber = mm
                    mm.Free()
                    CloseHid(dev)
                End If
        ...
        Public Property ProductString As String
            Get
                If _ProductString Is Nothing Then
                    ...
                    Dim mm As MemPtr
                    mm.AllocZero(512)
                    HidD_GetProductString(dev, mm, mm.Length)
                    _ProductString = mm
                    mm.Free()
                    CloseHid(dev)
                End If
        ...
        Public Property PhysicalDescriptor As String
            Get
                If _PhysicalDescriptor Is Nothing Then
                    ...
                    Dim mm As MemPtr
                    mm.AllocZero(512)
                    HidD_GetPhysicalDescriptor(dev, mm, mm.Length)
                    _PhysicalDescriptor = mm
                    mm.Free()
                    CloseHid(dev)
                End If
        ...
        Protected Overrides Sub ParseHw()
            ...
            For Each hw As String In _HardwareIds
                ...
                If i >= 0 Then
                    ...
                    If v.Length > 1 Then
                        If UShort.TryParse(v(1).Replace("_U", ""), Globalization.NumberStyles.AllowHexSpecifier, Globalization.CultureInfo.CurrentCulture.NumberFormat, CUShort(_HidPage)) Then
