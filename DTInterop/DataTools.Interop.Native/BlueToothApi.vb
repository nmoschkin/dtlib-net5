...
Namespace Native
    ...
    Friend Module BluetoothApi
        ...
        Public Function BTH_ERROR(_btStatus As Byte) As Byte
            Return ((_btStatus) <> BTH_ERROR_SUCCESS)
        End Function

        Public Function BTH_SUCCESS(_btStatus As Byte) As Byte
            Return ((_btStatus) = BTH_ERROR_SUCCESS)
        End Function
        ...
        ''
        Public ReadOnly IOCTL_INTERNAL_BTH_SUBMIT_BRB As CTL_CODE = BTH_KERNEL_CTL(BTH_IOCTL_BASE + &H0)

        ''
        '' Input:  none
        '' Output:  BTH_ENUMERATOR_INFO
        ''
        Public ReadOnly IOCTL_INTERNAL_BTHENUM_GET_ENUMINFO As CTL_CODE = BTH_KERNEL_CTL(BTH_IOCTL_BASE + &H1)

        ''
        '' Input:  none
        '' Output:  BTH_DEVICE_INFO
        ''
        Public ReadOnly IOCTL_INTERNAL_BTHENUM_GET_DEVINFO As CTL_CODE = BTH_KERNEL_CTL(BTH_IOCTL_BASE + &H2)
        ...
        ''
        Public ReadOnly IOCTL_BTH_GET_LOCAL_INFO As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H0)

        ''
        '' Input:  BTH_ADDR
        '' Output:  BTH_RADIO_INFO
        ''
        Public ReadOnly IOCTL_BTH_GET_RADIO_INFO As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H1)
        ...
        ''
        Public ReadOnly IOCTL_BTH_GET_DEVICE_INFO As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H2)

        ''
        '' Input:  BTH_ADDR
        '' Output:  none
        ''
        Public ReadOnly IOCTL_BTH_DISCONNECT_DEVICE As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H3)
        ''
        '' Input:   BTH_VENDOR_SPECIFIC_COMMAND 
        '' Output:  PVOID
        ''
        Public ReadOnly IOCTL_BTH_HCI_VENDOR_COMMAND As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H14)
        ''
        '' Input:  BTH_SDP_CONNECT
        '' Output:  BTH_SDP_CONNECT
        ''
        Public ReadOnly IOCTL_BTH_SDP_CONNECT As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H80)

        ''
        '' Input:  HANDLE_SDP
        '' Output:  none
        ''
        Public ReadOnly IOCTL_BTH_SDP_DISCONNECT As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H81)

        ''
        '' Input:  BTH_SDP_SERVICE_SEARCH_REQUEST
        '' Output:  ULong * number of handles wanted
        ''
        Public ReadOnly IOCTL_BTH_SDP_SERVICE_SEARCH As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H82)

        ''
        '' Input:  BTH_SDP_ATTRIBUTE_SEARCH_REQUEST
        '' Output:  BTH_SDP_STREAM_RESPONSE Or bigger
        ''
        Public ReadOnly IOCTL_BTH_SDP_ATTRIBUTE_SEARCH As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H83)

        ''
        '' Input:  BTH_SDP_SERVICE_ATTRIBUTE_SEARCH_REQUEST
        '' Output:  BTH_SDP_STREAM_RESPONSE Or bigger
        ''
        Public ReadOnly IOCTL_BTH_SDP_SERVICE_ATTRIBUTE_SEARCH As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H84)

        ''
        '' Input:  raw SDP stream (at least 2 bytes)
        '' Ouptut: HANDLE_SDP
        ''
        Public ReadOnly IOCTL_BTH_SDP_SUBMIT_RECORD As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H85)

        ''
        '' Input:  HANDLE_SDP
        '' Output:  none
        ''
        Public ReadOnly IOCTL_BTH_SDP_REMOVE_RECORD As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H86)

        ''
        '' Input:  BTH_SDP_RECORD + raw SDP record
        '' Output:  HANDLE_SDP
        ''
        Public ReadOnly IOCTL_BTH_SDP_SUBMIT_RECORD_WITH_INFO As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H87)

        ''
        '' Input:  NONE
        '' Output:  BTH_HOST_FEATURE_MASK
        ''
        Public ReadOnly IOCTL_BTH_GET_HOST_SUPPORTED_FEATURES As CTL_CODE = BTH_CTL(BTH_IOCTL_BASE + &H88)
        ...
        Public Structure BTH_DEVICE_INFO_LIST
            ...
            Public Shared Function FromPointer(ptr As IntPtr) As BTH_DEVICE_INFO_LIST
                ...
                op.numOfDevices = mm.UIntegerAt(0)

                ReDim op.deviceList(0 To op.numOfDevices - 1)

                For i = 0 To op.numOfDevices - 1
        ...
        Public Structure PBTH_DEVICE_INFO_LIST
            ...
            Shared Function CalcElementsFromSize(size As Integer) As Integer
                ...
                size /= Marshal.SizeOf(Of BTH_DEVICE_INFO)
            ...
            Public Sub Free()
                If (_ptr <> MemPtr.InvalidHandle And _ptr <> MemPtr.Empty) Then
                    Try
                        _ptr.Free()
            ...
            Public ReadOnly Property Devices(index As UInteger) As BTH_DEVICE_INFO
                Get
                    ...
                    Dim offset As IntPtr = Marshal.SizeOf(Of UInteger) + (Marshal.SizeOf(Of BTH_DEVICE_INFO) * index)
        ...
        Public ReadOnly HANDLE_SDP_NULL As IntPtr = 0

        Public ReadOnly HANDLE_SDP_LOCAL As IntPtr = -2
        ...
        Public Structure BTH_SDP_RECORD
            ...
            Public Function ToPointer() As SafePtr
                ...
                mm.UIntegerAt(0) = fSecurity
                mm.UIntegerAt(1) = fOptions
                mm.UIntegerAt(2) = fCodService

                mm.UIntegerAt(3) = recordLength

                mm.SetBytes(16, record)
            ...
            Public Shared Function FromPointer(ptr As IntPtr) As BTH_SDP_RECORD
                ...
                op.fSecurity = mm.UIntegerAt(0)
                op.fOptions = mm.UIntegerAt(1)
                op.fCodService = mm.UIntegerAt(2)
                op.recordLength = mm.UIntegerAt(3)

                op.record = mm.GrabBytes(16, op.recordLength)
        ...
        Public Structure BTH_SDP_ATTRIBUTE_SEARCH_REQUEST
            ...
            Public Function ToPointer() As SafePtr
                ...
                If (ofs = 4) Then
                    mm.UIntegerAt(0) = hConnection
                Else
                    mm.ULongAt(0) = hConnection
                End If

                mm.UIntegerAtAbsolute(ofs) = searchFlags
                mm.UIntegerAtAbsolute(ofs + 4) = recordHandle
        ...
        Public Structure BTH_SDP_SERVICE_ATTRIBUTE_SEARCH_REQUEST
            ...
            Public Function ToPointer() As SafePtr
                ...
                For j = 0 To MAX_UUIDS_IN_QUERY - 1
        ...
        Public Structure BTH_SDP_STREAM_RESPONSE
            ...
            Public Shared Function FromPointer(ptr As IntPtr) As BTH_SDP_STREAM_RESPONSE
                ...
                op.requiredSize = mm.UIntegerAt(0)
                op.responseSize = mm.UIntegerAt(1)
                op.response = mm.GrabBytes(8, op.responseSize)
        ...
        Public Structure BTH_VENDOR_SPECIFIC_COMMAND
            ...
            Public Function ToPointer() As SafePtr
                ...
                HciHeader.TotalParameterLength = Data.Length

                mm.Alloc(size)

                mm.UIntegerAt(0) = ManufacturerId
            ...
            Public Shared Function FromPointer(ptr As IntPtr) As BTH_VENDOR_SPECIFIC_COMMAND
                ...
                op.ManufacturerId = mm.UIntegerAt(0)
                op.LmpVersion = mm.ByteAt(4)
                op.MatchAnySinglePattern = mm.ByteAt(5)
                op.HciHeader = mm.ToStructAt(Of BTH_COMMAND_HEADER)(6)
                op.Data = mm.GrabBytes(6 + Marshal.SizeOf(Of BTH_COMMAND_HEADER), op.HciHeader.TotalParameterLength)
        ...
        Public Structure BTH_VENDOR_PATTERN
            ...
            Public Shared Function FromPointer(ptr As IntPtr) As BTH_VENDOR_PATTERN
                ...
                op.Pattern = mm.GrabBytes(2, op.Size)
        ...
        Public Structure BTH_VENDOR_EVENT_INFO
            ...
            Public Function ToPointer() As SafePtr
                ...
                EventSize = EventInfo.Length

                mm.Alloc(size)

                mm.ULongAt(0) = BthAddress
                mm.UIntegerAtAbsolute(8) = EventSize

                mm.SetBytes(12, EventInfo)
            ...
            Public Shared Function FromPointer(ptr As IntPtr) As BTH_VENDOR_EVENT_INFO
                ...
                op.EventSize = mm.UIntegerAtAbsolute(8)
                op.EventInfo = mm.GrabBytes(12, op.EventSize)
        ...
        Public Function _internalEnumBluetoothRadios() As BLUETOOTH_RADIO_INFO()
            ...
            If (hFind = 0) Then Return Nothing

            Do
                brInfo = New BLUETOOTH_RADIO_INFO()
                brInfo.dwSize = Marshal.SizeOf(Of BLUETOOTH_RADIO_INFO)
