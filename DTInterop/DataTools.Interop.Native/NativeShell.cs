...
namespace DataTools.Interop.Native
{
    ...
    {
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        extern void ParseDisplayName(IntPtr hwnd, [In][MarshalAs(UnmanagedType.Interface)] ref IBindCtx pbc, [In][MarshalAs(UnmanagedType.LPWStr)] string pszDisplayName, [In] out uint pchEaten, out IntPtr ppidl, [In] out uint pdwAttributes);
        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        extern void GetAttributesOf([In] uint cidl, [In] IntPtr apidl, [In] out uint rgfInOut);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        extern void GetUIObjectOf([In] IntPtr hwndOwner, [In] uint cidl, [In] IntPtr apidl, [In] ref Guid riid, [In] out uint rgfReserved, ref IntPtr ppv);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    ...
    public static class NativeShell
    {
        ...
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        internal static extern int SHCreateItemFromParsingName([MarshalAs(UnmanagedType.LPWStr)] string path, IntPtr pbc, ref Guid riid, [MarshalAs(UnmanagedType.Interface)] ref IShellItem2 shellItem);
        ...
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern HResult SHCreateItemWithParent(IntPtr pidlParaent, IShellFolder psfParent, IntPtr pidl, ref Guid riid, [MarshalAs(UnmanagedType.Interface)] ref object ppvItem);
        ...
        public static extern HResult SHParseDisplayName([In][MarshalAs(UnmanagedType.LPWStr)] string pszName, [In] IntPtr pbc, out IntPtr ppidl, [In] ShellFileGetAttributesOptions sfgaoIn, [In] out ShellFileGetAttributesOptions psfgaoOut);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern HResult SHParseDisplayName(IntPtr pszName, IntPtr pbc, out IntPtr ppidl, ShellFileGetAttributesOptions sfgaoIn, ref ShellFileGetAttributesOptions psfgaoOut);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern bool SHObjectProperties(IntPtr hwnd, SHOPType shopObjectType, string pszObjectName, string pszPropertyPage);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern HResult SHBindToObject(IShellFolder psf, IntPtr pidl, IntPtr pbc, ref Guid riid, [MarshalAs(UnmanagedType.Interface)] ref object ppv);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern int SHGetIDListFromObject(IntPtr iUnknown, ref IntPtr ppidl);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern int SHGetDesktopFolder([MarshalAs(UnmanagedType.Interface)] ref IShellFolder ppshf);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern int SHCreateShellItem(IntPtr pidlParent, [In][MarshalAs(UnmanagedType.Interface)] IShellFolder psfParent, IntPtr pidl, [MarshalAs(UnmanagedType.Interface)] ref IShellItem ppsi);
        [DllImport("shell32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        ...
        public static extern int SHShowManageLibraryUI([In][MarshalAs(UnmanagedType.Interface)] IShellItem library, [In] IntPtr hwndOwner, [In] string title, [In] string instruction, [In] LibraryManageDialogOptions lmdOptions);
        ...
        public struct STRRET
        {
            ...
            // <FieldOffset(4)>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Native.FileApi.MAX_PATH)]
            public char[] _cStr;
        }
...
#error Cannot convert LocalDeclarationStatementSyntax - see comment for details
            ...
            Input:
                        ...
                        Static lAssoc As New Global.System.Collections.Generic.List(Of Global.DataTools.Interop.Native.IAssocHandler)

             */
            if (Conversions.ToBoolean(lAssoc.Count))
                lAssoc.Clear();
            ...
            try
            {
                NativeShell.SHAssocEnumHandlers(ref fileExtension, ASSOC_FILTER.RECOMMENDED, ref handlers);
            }
            catch (Exception ex)
            {
                return null;
    ...
    public sealed class PropVariant : IDisposable
    {
            ...
            lock (_padlock)
            {
                ...
                if (!_cache.TryGetValue(type, out action))
                {
                    ...
                    if (constructor is null)
                    {
                        ...
                        throw new ArgumentException(Interop.My.Resources.LocalizedMessages.PropVariantTypeNotSupported);
                    }
                    else
                    {
        ...
        public PropVariant(string value)
        {
            if (value is null)
            {
                throw new ArgumentException(Interop.My.Resources.LocalizedMessages.PropVariantNullString, "value");
            }
        ...
        private static FILETIME DateTimeToFileTime(DateTime value)
        {
            ...
            var ft = new FILETIME();
            ft.dwLowDateTime = (int)(hFT & 0xFFFFFFFFUIL);
        ...
        private Array GetVector<T>()
        {
            ...
            {
                throw new InvalidCastException(Interop.My.Resources.LocalizedMessages.PropVariantUnsupportedType);
            }
        ...
        private static Array CrackSingleDimSafeArray(IntPtr psa)
        {
            ...
            if (cDims != 1L)
            {
                throw new ArgumentException(Interop.My.Resources.LocalizedMessages.PropVariantMultiDimArray, "psa");
            }
    ...
    internal sealed class PropVariantNativeMethods
    {
        ...
        [DllImport("propsys.dll", CharSet = CharSet.Unicode, SetLastError = true, PreserveSig = false)]
        internal static extern void InitPropVariantFromFileTime([In] ref FILETIME pftIn, out PropVariant ppropvar);
        [DllImport("propsys.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        ...
        [DllImport("propsys.dll", CharSet = CharSet.Unicode, SetLastError = true, PreserveSig = false)]
        internal static extern void InitPropVariantFromFileTimeVector([In] out FILETIME[] prgft, uint cElems, out PropVariant ppropvar);
        [DllImport("propsys.dll", CharSet = CharSet.Unicode, SetLastError = true, PreserveSig = false)]
    ...
    public interface IPropertyDescription
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        extern void CoerceToCanonicalValue([In] out PropVariant propvar);
