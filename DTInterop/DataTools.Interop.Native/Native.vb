...
#Region "ListView"
        ...
        Public Function ListView_SetUnicodeFormat(hwnd As IntPtr, fUnicode As Integer) As Integer
            Return SendMessage(hwnd, LVM_SETUNICODEFORMAT, fUnicode, 0)
        End Function

        Public Function ListView_GetUnicodeFormat(hwnd As IntPtr) As Integer
        ...
        Public Function ListView_SetBkColor(hwnd As IntPtr) As System.Drawing.Color
            Return Color.FromArgb(SendMessage(hwnd, LVM_GETBKCOLOR, 0, 0))
        End Function
        ...
        Public Function ListView_SetImageList(hwnd As IntPtr, iImageList As Integer, hImageList As IntPtr) As Integer
            Return SendMessage(hwnd, LVM_SETIMAGELIST, iImageList, hImageList)
        End Function

        Public Const LVM_GETITEMCOUNT = (LVM_FIRST + 4)

        Public Function ListView_GetItemCount(hwnd As IntPtr) As Integer
...
#Region "Structures"
        ...
        Public Structure SYSTEMTIME
            ...
            Public Shared Widening Operator CType(operand As SYSTEMTIME) As Date
            ...
            Public Sub New(t As Date)
                wYear = t.Year
                wMonth = t.Month
                wDayOfWeek = t.DayOfWeek
                wDay = t.Day
                wHour = t.Hour
                wMinute = t.Minute
                wSecond = t.Second
                wMilliseconds = t.Millisecond
            End Sub
        ...
        Public Structure FILETIME
            ...
            Public Sub New(t As Long)
                Me.lo = (t And &HFFFFFFFF)
                Me.hi = t And (&HFFFFFFFF00000000 >> 32)
            End Sub
        ...
        Public Structure WIN32_FIND_DATA
            ...
            Public Property cFilename As String
                ...
                Set(value As String)
                    Dim mm As MemPtr
                    mm = value
                    MemCpy(_cFilename, mm.Handle, CType(mm.Length(), Integer))
                End Set
            End Property
            ...
            Public Property cAlternate As String
                ...
                Set(value As String)
                    Dim mm As MemPtr
                    mm = value
                    MemCpy(_cAlternate, mm.Handle, CType(mm.Length(), Integer))
                End Set
            End Property
            ...
            Public Property nFileSize As Long
                ...
                End Get
                Set(value As Long)
                    nFileSizeHigh = ((value >> 32) And &HFFFFFFFFL)
                    nFileSizeLow = (value And &HFFFFFFFFL)
                End Set
            End Property
        End Structure
...
#Region "Windows"
        ...
        Public Declare Unicode Function GetDC Lib "user32" (ByVal hWnd As System.IntPtr) As System.IntPtr
        Public Declare Unicode Function ReleaseDC Lib "user32" (ByVal hWnd As System.IntPtr, ByVal hDC As System.IntPtr) As Integer

        Public Declare Unicode Function SystemParametersInfo Lib "user32" Alias "SystemParametersInfoW" (ByVal uAction As Integer, ByVal uParam As Integer, ByRef lpvParam As Object, ByVal fuWinIni As Integer) As Integer
        Public Declare Unicode Function SystemParametersInfo Lib "user32" Alias "SystemParametersInfoW" (ByVal uAction As Integer, ByVal uParam As Integer, <MarshalAs(UnmanagedType.LPStruct)> ByRef lpvParam As NONCLIENTMETRICS, ByVal fuWinIni As Integer) As Integer

        Public Declare Unicode Function SendMessage Lib "user32" Alias "SendMessageW" (ByVal hWnd As IntPtr, ByVal wMsg As UInteger, ByVal wParam As Integer, ByVal lParam As Integer) As IntPtr
        Public Declare Unicode Function SendMessage Lib "user32" Alias "SendMessageW" (ByVal hWnd As IntPtr, ByVal wMsg As UInteger, ByVal wParam As Integer, ByVal lParam As IntPtr) As IntPtr

        Public Declare Unicode Function SendMessage Lib "user32" Alias "SendMessageW" (ByVal hWnd As IntPtr, ByVal wMsg As UInteger, ByVal wParam As IntPtr, ByVal lParam As Integer) As IntPtr
        Public Declare Unicode Function SendMessage Lib "user32" Alias "SendMessageW" (ByVal hWnd As IntPtr, ByVal wMsg As UInteger, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As IntPtr

        Public Declare Unicode Function PostMessage Lib "user32" Alias "PostMessageW" (ByVal hWnd As IntPtr, ByVal wMsg As UInteger, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As Boolean

        Public Declare Unicode Function GetLastError Lib "kernel32" () As UInteger
        Public Declare Unicode Function FormatMessage Lib "kernel32" Alias "FormatMessageW" (ByVal dwFlags As UInteger, ByVal lpSource As IntPtr, ByVal dwMessageId As UInteger, ByVal dwLanguageId As UInteger, ByVal lpBuffer As IntPtr, ByVal dwSize As UInteger, ByVal va_list As IntPtr) As Integer

        '' Executable assembly version functions for 16, 32 and 64 bit binaries.
        Public Declare Unicode Function GetFileVersionInfo Lib "version.dll" Alias "GetFileVersionInfoW" (<MarshalAs(UnmanagedType.LPTStr)> lptstrFilename As String, dwHandle As IntPtr, dwLen As Integer, ByVal lpData As IntPtr) As <MarshalAs(UnmanagedType.Bool)> Boolean
...
#Region "DLL Library Functions"
        ...
        Public Function GetProcAddressDelegate(ByVal hModule As IntPtr, <MarshalAs(UnmanagedType.LPWStr)> lpProcName As String) As [Delegate]
        End Function

        <DllImport("kernel32.dll", SetLastError:=True)>
        Public Function FreeLibrary(ByVal hInst As IntPtr) As IntPtr
        End Function

        <DllImport("user32.dll", SetLastError:=True)>
        Public Function LoadImage(ByVal hInst As IntPtr, <MarshalAs(UnmanagedType.LPWStr)> ByVal lpszName As String, ByVal uType As Int32,
                                    ByVal cxDesired As Integer, ByVal cyDesired As Integer, ByVal fuLoad As Int32) As IntPtr
        End Function

        <DllImport("user32.dll", SetLastError:=True)>
        Public Function LoadImage(ByVal hInst As IntPtr, ByVal lpszName As IntPtr, ByVal uType As Int32,
            ByVal cxDesired As Integer, ByVal cyDesired As Integer, ByVal fuLoad As Int32) As IntPtr
        End Function
...
#Region "Windows Shell"
        ...
        Public Declare Unicode Function ExtractIconEx2 Lib "shell32.dll" Alias "ExtractIconExW" (<MarshalAs(UnmanagedType.LPTStr)> lpszFile As String, nIconIndex As Integer, ByVal phiconLarge As IntPtr, ByVal phiconSmall As IntPtr, nIcons As UInteger) As Integer
        ...
        Public Declare Unicode Function SHGetSpecialFolderPath Lib "Shell32" Alias "SHGetSpecialFolderPathW" (ByVal hWnd As IntPtr, ByVal lpPath As String, ByVal nFolder As Integer, ByVal fCreate As Boolean) As Integer
        Public Declare Unicode Function SHGetPathFromIDList Lib "Shell32" (ByVal pidl As Integer, <MarshalAs(UnmanagedType.LPWStr)> ByVal pszPath As String) As Integer
        ...
        Public Declare Unicode Function SHGetFileInfo Lib "shell32.dll" Alias "SHGetFileInfoW" (<MarshalAs(UnmanagedType.LPWStr)> pszPath As String, ByVal dwFileAttributes As Integer, ByRef psfi As SHFILEINFO, ByVal cbFileInfo As Integer, ByVal uFlags As Integer) As Integer
        Public Declare Unicode Function SHGetItemInfo Lib "shell32.dll" Alias "SHGetFileInfoW" (ByVal pidl As IntPtr, ByVal dwFileAttributes As Integer, ByRef psfi As SHFILEINFO, ByVal cbFileInfo As Integer, ByVal uFlags As Integer) As IntPtr
        ...
        Public Declare Unicode Function SHGetDataFromIDList Lib "shell32.dll" Alias "SHGetDataFromIDListW" (<MarshalAs(UnmanagedType.Interface)> ByVal lpFolder As Object, ByVal pidl As Integer, ByVal nFormat As Integer, pv As IntPtr, ByVal cb As Integer) As Integer
        ...
        Public Declare Unicode Function CopyImage Lib "user32" (ByVal Handle As IntPtr, ByVal un1 As Integer, ByVal n1 As Integer, ByVal n2 As Integer, ByVal un2 As Integer) As Integer
...
#Region "Windowing"
        ...
        Public Function SetWindowLongPtr(ByVal hWnd As System.IntPtr, ByVal code As Integer, ByVal value As IntPtr) As IntPtr
        End Function
        ...
        Public Declare Unicode Function GetSysColor Lib "user32" (ByVal nIndex As Integer) As Integer
...
#Region "Menu System"
        ...
        Public Declare Unicode Function GetMessage Lib "user32" Alias "GetMessageW" (<MarshalAs(UnmanagedType.LPStruct)> ByRef lpMsg As MSG, ByVal hWnd As IntPtr, ByVal wMsgFilterMin As Integer, ByVal wMsgFilterMax As Integer) As Integer
        Public Declare Unicode Function PeekMessage Lib "user32" Alias "PeekMessageW" (<MarshalAs(UnmanagedType.LPStruct)> ByRef lpMsg As MSG, ByVal hWnd As IntPtr, ByVal wMsgFilterMin As Integer, ByVal wMsgFilterMax As Integer, ByVal wRemoveMsg As Integer) As Integer
        ...
        Public Declare Unicode Function GetKeyState Lib "user32" (ByVal nVirtKey As Integer) As Integer

        Public Declare Unicode Function CopyAcceleratorTable Lib "user32" Alias "CopyAcceleratorTableW" (ByVal hAccelSrc As IntPtr, ByVal lpAccelDst As IntPtr, ByVal cAccelEntries As Integer) As Integer
        Public Declare Unicode Function CreateAcceleratorTable Lib "user32" Alias "CreateAcceleratorTableW" (ByVal lpaccl As IntPtr, ByVal cEntries As Integer) As Integer
        Public Declare Unicode Function TranslateAccelerator Lib "user32" Alias "TranslateAcceleratorW" (ByVal hWnd As IntPtr, ByVal hAccTable As IntPtr, <MarshalAs(UnmanagedType.LPStruct)> ByRef lpMsg As MSG) As Integer
        Public Declare Unicode Function DestroyAcceleratorTable Lib "user32" (ByVal haccel As IntPtr) As Integer

        Public Declare Unicode Function TrackPopupMenu Lib "user32" (ByVal Handle As IntPtr, ByVal wFlags As UInteger, ByVal x As Short, ByVal y As Short, ByVal nReserved As Short, ByVal hWnd As IntPtr, ByVal lprc As IntPtr) As Integer
        Public Declare Unicode Function TrackPopupMenuEx Lib "user32" (ByVal Handle As IntPtr, ByVal wFlags As UInteger, ByVal x As Integer, ByVal y As Integer, ByVal hWnd As IntPtr, ByVal lpTPMParams As IntPtr) As IntPtr

        Public Declare Unicode Function DrawMenuBar Lib "user32" (ByVal hWnd As IntPtr) As Integer
        ...
        Public Declare Unicode Function DeleteMenu Lib "user32" (ByVal Handle As IntPtr, ByVal nPosition As Integer, ByVal wFlags As Integer) As Integer

        Public Declare Unicode Function InsertMenuItem Lib "user32" Alias "InsertMenuItemW" (ByVal Handle As IntPtr, ByVal un As Integer, ByVal bool As Boolean, <MarshalAs(UnmanagedType.Struct)> ByRef lpcMenuItemInfo As MENUITEMINFO) As Integer

        Public Declare Unicode Function AppendMenu Lib "user32" Alias "AppendMenuW" (ByVal Handle As IntPtr, ByVal wFlags As Integer, ByVal wIDNewItem As Integer, ByVal lpNewItem As IntPtr) As Integer

        Public Declare Unicode Function InsertMenu Lib "user32" Alias "InsertMenuW" (ByVal Handle As IntPtr, ByVal nPosition As Integer, ByVal wFlags As Integer, ByVal wIDNewItem As Integer, ByVal lpNewItem As IntPtr) As Integer

        Public Declare Unicode Function RemoveMenu Lib "user32" (ByVal Handle As IntPtr, ByVal nPosition As Integer, ByVal wFlags As Integer) As Integer
        Public Declare Unicode Function DestroyMenu Lib "user32" (ByVal Handle As IntPtr) As Integer

        Public Declare Unicode Function GetSystemMenu Lib "user32" (ByVal hWnd As Integer, ByVal bRevert As Integer) As Integer

        Public Declare Unicode Function GetMenuItemCount Lib "user32" (ByVal Handle As IntPtr) As Integer
        Public Declare Unicode Function GetMenuItemID Lib "user32" (ByVal Handle As IntPtr, ByVal nPos As UInteger) As Integer
        Public Declare Unicode Function GetMenuDefaultItem Lib "user32" (ByVal Handle As IntPtr, <MarshalAs(UnmanagedType.Bool)> ByVal fByPos As Boolean, ByVal gmdiFlags As Integer) As UInteger
        Public Declare Unicode Function GetMenuContextHelpId Lib "user32" (ByVal Handle As IntPtr) As Integer
        Public Declare Unicode Function GetMenuCheckMarkDimensions Lib "user32" () As Integer

        Public Declare Unicode Function GetMenu Lib "user32" (ByVal hWnd As Integer) As Integer

        Public Declare Unicode Function GetMenuItemInfo Lib "user32" Alias "GetMenuItemInfoW" (ByVal Handle As IntPtr, ByVal un As UInteger, <MarshalAs(UnmanagedType.Bool)> ByVal fByItem As Boolean, ByRef lpMenuItemInfo As MENUITEMINFO) As Integer

        Public Declare Unicode Function GetMenuInfo Lib "user32" (ByVal hMenu As IntPtr, lpcmi As MENUINFO) As Integer
        Public Declare Unicode Function GetMenuBarInfo Lib "user32" (ByVal hWnd As IntPtr, ByVal idObject As Integer, ByVal idItem As UInteger, <MarshalAs(UnmanagedType.LPStruct)> ByRef pmbi As MENUBARINFO) As Integer

        Public Declare Unicode Function GetMenuItemRect Lib "user32" (ByVal hWnd As IntPtr, ByVal Handle As IntPtr, ByVal uItem As UInteger, <MarshalAs(UnmanagedType.LPStruct)> ByRef lprcItem As RECT) As Integer
        Public Declare Unicode Function GetMenuState Lib "user32" (ByVal Handle As IntPtr, ByVal wID As UInteger, ByVal wFlags As Integer) As Integer

        Public Declare Unicode Function GetMenuString Lib "user32" Alias "GetMenuStringW" (ByVal Handle As IntPtr, ByVal wIDItem As UInteger, <MarshalAs(UnmanagedType.LPWStr)> lpString As String, ByVal nMaxCount As Integer, ByVal wFlag As Integer) As Integer

        Public Declare Unicode Function SetMenuInfo Lib "user32" (ByVal hMenu As IntPtr, <MarshalAs(UnmanagedType.LPStruct)> lpcmi As MENUINFO) As Integer

        Public Declare Unicode Function SetMenu Lib "user32" (ByVal hWnd As IntPtr, ByVal Handle As IntPtr) As Integer
        Public Declare Unicode Function SetMenuContextHelpId Lib "user32" (ByVal Handle As IntPtr, ByVal dw As Integer) As Integer
        Public Declare Unicode Function SetMenuDefaultItem Lib "user32" (ByVal Handle As IntPtr, ByVal uItem As UInteger, ByVal fByPos As Integer) As Integer
        Public Declare Unicode Function SetMenuItemBitmaps Lib "user32" (ByVal Handle As IntPtr, ByVal nPosition As UInteger, ByVal wFlags As Integer, ByVal hBitmapUnchecked As Integer, ByVal hBitmapChecked As Integer) As Integer
        Public Declare Unicode Function EnableMenuItem Lib "user32" (ByVal hMenu As IntPtr, ByVal wIDEnableItem As UInteger, ByVal wEnable As Integer) As Integer

        Public Declare Unicode Function SetMenuItemInfo Lib "user32" Alias "SetMenuItemInfoW" (ByVal Handle As IntPtr, ByVal un As UInteger, <MarshalAs(UnmanagedType.Bool)> ByVal fByItem As Boolean, ByRef lpcMenuItemInfo As MENUITEMINFO) As Integer

#End Region

#Region "Scrollbars"
        Public Declare Unicode Function SetScrollInfo Lib "user32" (ByVal hWnd As System.IntPtr, ByVal n As Integer, <MarshalAs(UnmanagedType.LPStruct)> ByRef lpcScrollInfo As SCROLLINFO, ByVal bool As Boolean) As Integer
        Public Declare Unicode Function SetScrollPos Lib "user32" (ByVal hWnd As System.IntPtr, ByVal nBar As Integer, ByVal nPos As Integer, ByVal bRedraw As Integer) As Integer
        Public Declare Unicode Function SetScrollRange Lib "user32" (ByVal hWnd As System.IntPtr, ByVal nBar As Integer, ByVal nMinPos As Integer, ByVal nMaxPos As Integer, ByVal bRedraw As Integer) As Integer
        Public Declare Unicode Function GetScrollInfo Lib "user32" (ByVal hWnd As System.IntPtr, ByVal n As Integer, <MarshalAs(UnmanagedType.LPStruct)> ByRef lpScrollInfo As SCROLLINFO) As Integer
        Public Declare Unicode Function GetScrollPos Lib "user32" (ByVal hWnd As System.IntPtr, ByVal nBar As Integer) As Integer
        Public Declare Unicode Function GetScrollRange Lib "user32" (ByVal hWnd As System.IntPtr, ByVal nBar As Integer, ByRef lpMinPos As Integer, ByRef lpMaxPos As Integer) As Integer
        Public Declare Unicode Function EnableScrollBar Lib "user32" (ByVal hWnd As System.IntPtr, ByVal wSBflags As Integer, ByVal wArrows As Integer) As Integer
        Public Declare Unicode Function ShowScrollBar Lib "user32" (ByVal hWnd As System.IntPtr, ByVal wBar As Integer, ByVal bShow As Integer) As Integer
#End Region

#Region "GDI Objects"
        Public Declare Unicode Function SelectObject Lib "gdi32" (ByVal hDC As System.IntPtr, ByVal hObject As IntPtr) As Integer
        Public Declare Unicode Function GetCurrentObject Lib "gdi32" (ByVal hDC As System.IntPtr, ByVal uObjectType As Integer) As Integer
        Public Declare Unicode Function GetStockObject Lib "gdi32" (ByVal nIndex As Integer) As Integer

        '' Pen
        Public Declare Unicode Function GetObject Lib "gdi32" (ByVal hObject As IntPtr, ByVal nCount As Integer, <MarshalAs(UnmanagedType.Struct)> lpObject As LOGPEN) As Integer

        '' Brush
        Public Declare Unicode Function GetObject Lib "gdi32" (ByVal hObject As IntPtr, ByVal nCount As Integer, <MarshalAs(UnmanagedType.Struct)> lpObject As LOGBRUSH) As Integer

        Public Declare Unicode Function ExtCreatePen Lib "gdi32" (ByVal dwPenStyle As Integer, ByVal dwWidth As Integer, <MarshalAs(UnmanagedType.Struct)> lplb As LOGBRUSH, ByVal dwStyleCount As Integer, ByVal lpStyle As Integer) As Integer

        Public Declare Unicode Function CreatePenIndirect Lib "gdi32" (<MarshalAs(UnmanagedType.Struct)> lpLogPen As LOGPEN) As Integer
        Public Declare Unicode Function CreatePen Lib "gdi32" (ByVal nPenStyle As Integer, ByVal nWidth As Integer, ByVal crColor As Integer) As Integer
...
#Region "GDI Paint"
        ...
        Public Declare Unicode Function FillRect Lib "user32" (ByVal hDC As System.IntPtr, <MarshalAs(UnmanagedType.Struct)> ByRef lpRect As RECT, ByVal hBrush As Integer) As Integer

        Public Declare Unicode Function BeginPaint Lib "user32" (ByVal hWnd As System.IntPtr, <MarshalAs(UnmanagedType.Struct)> ByRef lpPaint As PAINTSTRUCT) As Integer
        Public Declare Unicode Function EndPaint Lib "user32" (ByVal hWnd As System.IntPtr, <MarshalAs(UnmanagedType.Struct)> ByRef lpPaint As PAINTSTRUCT) As Integer

        Public Declare Unicode Function SetTextAlign Lib "gdi32" (ByVal hDC As System.IntPtr, ByVal wFlags As Integer) As Integer
        Public Declare Unicode Function GetTextAlign Lib "gdi32" (ByVal hDC As System.IntPtr) As Integer

        Public Declare Unicode Function SetBkMode Lib "gdi32" (ByVal hDC As System.IntPtr, ByVal nMode As Integer) As Integer

        Public Declare Unicode Function DrawTextW Lib "user32" (ByVal hDC As System.IntPtr, <MarshalAs(UnmanagedType.LPWStr)> ByRef lpStr As String, ByVal nCount As Integer, <MarshalAs(UnmanagedType.Struct)> ByRef lpRect As RECT, ByVal wFormat As Integer) As Integer
        ...
        Public Declare Unicode Function DrawFrameControl Lib "user32" (ByVal hDC As System.IntPtr, <MarshalAs(UnmanagedType.Struct)> ByRef lpRect As RECT, ByVal un1 As Integer, ByVal un2 As Integer) As Integer
        '' draw caption text

        Public Declare Unicode Function DrawCaption Lib "user32" (ByVal hWnd As IntPtr, ByVal hDC As IntPtr, <MarshalAs(UnmanagedType.Struct)> ByRef pcRect As RECT, ByVal un As Integer) As Integer
...
#Region "Zero Memory"
        ...
        Declare Sub RtlZeroMemory Lib "kernel32" Alias "RtlZeroMemory" (ByVal pDst As IntPtr,
