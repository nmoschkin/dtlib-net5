...
#Region "Heap Functions"
        ...
        Friend Function HeapCreate(ByVal dwOptions As Integer,
                                ByVal initSize As IntPtr,
                                ByVal maxSize As IntPtr) As IntPtr

        End Function

        <DllImport("kernel32", EntryPoint:="HeapDestroy", CharSet:=CharSet.Unicode, PreserveSig:=True, SetLastError:=True)>
        Friend Function HeapDestroy(ByVal hHeap As IntPtr) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        Friend Function HeapQueryInformation(ByVal HeapHandle As IntPtr,
                                            ByVal HeapInformationClass As Integer,
                                            ByRef HeapInformation As ULong,
                                            ByVal HeapInformationLength As IntPtr,
                                            ByVal ReturnLength As IntPtr) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        Friend Function HeapReAlloc(ByVal hHeap As IntPtr,
                                    ByVal dwOptions As Integer,
                                    ByVal lpMem As IntPtr,
                                    ByVal dwBytes As IntPtr) As IntPtr
...
#Region "Arrays"
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Char(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Byte(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As SByte(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As ULong(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As IntPtr,
                                                                         ByVal pSrc As UShort(),
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UShort(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As IntPtr,
                                                                         ByVal pSrc As UInteger(),
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UInteger(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Long(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Short(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Integer(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
...
#Region "Unique Types"
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Date(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As IntPtr,
                                                                         ByVal pSrc As System.Guid(),
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As System.Guid(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As IntPtr,
                                                                         ByVal pSrc As BigInteger,
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As BigInteger,
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)

        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As IntPtr,
                                                                         ByVal pSrc As System.Drawing.Color,
                                                                         ByVal byteLen As IntPtr)
        ...
        Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As System.Drawing.Color(),
                                                                         ByVal pSrc As IntPtr,
                                                                         ByVal byteLen As IntPtr)
...
#Region "UNative Declarations"
    ...
    '    '    Declare Function HeapCreate Lib "kernel32" (ByVal dwOptions As Integer, _
    '    '                                                ByVal initSize As UIntPtr, _
    '    '                                                ByVal maxSize As UIntPtr) As UIntPtr

    '    '    Declare Function HeapDestroy Lib "kernel32" (ByVal hHeap As UIntPtr) As Boolean

    '    '    Declare Function GetProcessHeap Lib "kernel32" () As UIntPtr

    '    '    Declare Function HeapQueryInformation Lib "kernel32" (ByVal HeapHandle As UIntPtr, _
    '    '                                                          ByVal HeapInformationClass As Integer, _
    '    '                                                          ByRef HeapInformation As UInteger, _
    '    '                                                          ByVal HeapInformationLength As UIntPtr, _
    '    '                                                          ByVal ReturnLength As UIntPtr) As Boolean
    ...
    '    '    Declare Function HeapAlloc Lib "kernel32" (ByVal hHeap As UIntPtr, _
    '    '                                               ByVal dwOptions As Integer, _
    '    '                                               ByVal dwBytes As UIntPtr) As UIntPtr

    '    '    Declare Function HeapReAlloc Lib "kernel32" (ByVal hHeap As UIntPtr, _
    '    '                                                 ByVal dwOptions As Integer, _
    '    '                                                 ByVal lpMem As UIntPtr, _
    '    '                                                 ByVal dwBytes As UIntPtr) As UIntPtr

    '    '    Declare Function HeapFree Lib "kernel32" (ByVal hHeap As UIntPtr, _
    '    '                                               ByVal dwOptions As Integer, _
    '    '                                               ByVal lpMem As UIntPtr) As UIntPtr

    '    '    Declare Function HeapSize Lib "kernel32" (ByVal hHeap As UIntPtr, _
    '    '                                              ByVal dwOptions As Integer, _
    '    '                                              ByVal lpMem As UIntPtr) As UIntPtr

    '    '    Declare Function HeapValidate Lib "kernel32" (ByVal hHeap As UIntPtr, _
    '    '                                              ByVal dwOptions As Integer, _
    '    '                                              ByVal lpMem As UIntPtr) As <MarshalAs(UnmanagedType.Bool)> Boolean
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                 ByVal pSrc As UIntPtr, _
    '    '                                                                 ByVal byteLen As UIntPtr)
    '    '#End Region
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As Char(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Char(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Byte(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As SByte(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As SByte(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As ULong(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As ULong(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As UShort(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UShort(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As UInteger(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UInteger(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Long(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As Short(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Short(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As Integer(), _
    '    '                                                                     ByVal byteLen As UIntPtr)
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As Date(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As Date(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As System.Guid(), _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As System.Guid(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As BigInteger, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As BigInteger, _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)

    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                     ByVal pSrc As System.Drawing.Color, _
    '    '                                                                     ByVal byteLen As UIntPtr)
    ...
    '    '    Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (ByVal pDst As System.Drawing.Color(), _
    '    '                                                                     ByVal pSrc As UIntPtr, _
    '    '                                                                     ByVal byteLen As UIntPtr)
    ...
    '    '    Declare Sub RtlZeroMemory Lib "kernel32" Alias "RtlZeroMemory" (ByVal pDst As UIntPtr, _
    '    '                                                                             ByVal byteLen As UIntPtr)
