...
#Region "BOM"
    ...
    Public Structure BOM
        ...
        Public Sub SetBOM(ByVal type As BOMTYPE)
        ...
        Public Overrides Function Equals(ByVal operand As Object) As Boolean
...
#Region "CodePageCollection Class"
    ...
    Friend Class CodePageCollection
        ...
        Public Sub Insert(index As Integer, value As CodePage, Optional ByVal key As String = "")
            List.Insert(index, value)
        End Sub 'Insert
