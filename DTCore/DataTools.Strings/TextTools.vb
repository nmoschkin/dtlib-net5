...
Namespace Strings
    ...
    Public Module TextTools
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function IsNumber(subject As String, Optional ByVal noTrim As Boolean = False) As Boolean
        ...
        ''' <returns>Processed text.</returns>
        ''' <remarks></remarks>
        Public Function TightenText(Input As String, Optional ByVal RemoveOperatorGaps As Boolean = True, Optional ByVal RemoveComments As Boolean = True, Optional ByVal CommentChars As String = "'") As String
        ...
        ''' <remarks></remarks>
        Public Function FVal(ByVal value As String) As Object
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function TextEscapeCSV(ByVal s As String) As String
            Dim b() As Char,
            i As Integer
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function TextEscapeJson(ByVal s As String) As String
            Dim b() As Char,
            i As Integer
        ...
        Public Function GetXMLTag(ByVal a() As Char, ByVal b As Integer, Optional ByRef e As Object = Nothing) As XMLTAG
        ...
        ''' <returns>Processed text.</returns>
        ''' <remarks></remarks>
        Public Function RemoveNulls(ByVal input As String) As String
        ...
        ''' <returns>Processed text.</returns>
        ''' <remarks></remarks>
        Public Function OneSpace(ByVal input As String, Optional spaceChars As String = " ", Optional PreserveQuotedText As Boolean = True, Optional quoteChar As Char = vbDblQuote, Optional escapeChar As Char = "\", Optional ByVal Quick As Boolean = True) As String
        ...
        ''' <remarks></remarks>
        Public Function Bracket(ByVal szText As String, Optional ByRef startIndex As Integer = Nothing, Optional ByRef newIndex As Integer = Nothing, Optional ByVal BracketPair As String = "()", Optional ByRef ErrorText As String = Nothing) As String
        ...
        ''' <returns>Processed text.</returns>
        ''' <remarks></remarks>
        Public Function SpaceOperators(ByVal value As String, Optional ByVal Operators As String = "/\&^%*-+()[]{}", Optional ByVal SepChars As String = Nothing, Optional ByVal StickyCharsLeft As String = "", Optional ByVal StickyCharsRight As String = "+-", Optional ByVal NoStickyChars As String = "") As String
            Dim i As Integer,
            c As Integer
        ...
        ''' <returns>Array of strings.</returns>
        ''' <remarks></remarks>
        Public Function Words(ByVal Text As String, Optional ByVal SepChars As String = Nothing, Optional ByVal AdditionalSepChars As String = Nothing, Optional ByVal SkipQuotes As Boolean = False, Optional ByVal Unescape As Boolean = False, Optional ByVal QuoteChar As String = vbDblQuote, Optional ByVal EscapeChar As String = "\") As String()
            Dim i As Integer,
            c As Integer
        ...
        ''' <remarks></remarks>
        Public Function Wrap(ByVal szText As String, Optional ByVal Cols As Integer = 60) As String
            Dim st() As String,
            xTot As Integer = 0,
            sOut As String = "",
            i As Integer,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetLines(ByVal szText As String) As String()
        ...
        ''' <remarks></remarks>
        Public Function NoComment(ByVal input As String, Optional ByVal commentchar As String = "//") As String
            Dim a As Integer,
            b As Integer
        ...
        ''' <remarks></remarks>
        Public Function CamelCase(input As String, Optional ByVal stripSpaces As Boolean = False, Optional noDecaps As Boolean = False) As String
        ...
        ''' <returns>A newly formatted string.</returns>
        ''' <remarks></remarks>
        Public Function TitleCase(ByVal input As String, Optional ByVal stripSpaces As Boolean = False, Optional noDecaps As Boolean = False) As String
            Dim a As Integer,
            b As Integer
        ...
        ''' <remarks></remarks>
        Public Function Stream(ByVal Text() As String) As String
            Dim i As Long,
            b As Long
        ...
        ''' <remarks></remarks>
        Public Function Filter(ByVal Text As String, Optional ByVal FilterPair As String = vbDblQuote, Optional ByVal Escape As String = "\", Optional ByRef FirstIsFilter As Boolean = Nothing, Optional ByVal OnlyBetween As Boolean = False) As String()
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function SearchReplace(ByVal InputStr As String, ByVal Search As String, ByVal Replace As String) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function NoNullLines(ByVal i As String) As String
            Dim st() As String,
            l As Integer
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function TrimWSpace(ByVal val As String) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function StrTok(Optional ByVal ScanString As String = "", Optional ByVal Token As String = "", Optional ByVal SyncTok As Boolean = False, Optional ByVal SkipQuotes As Boolean = False, Optional ByVal QuoteChar As String = vbDblQuote, Optional ByVal EscapeChar As String = "\") As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function QuoteFromHere(ByVal StrData As String, ByVal Pos As Long, Optional ByVal QuoteChar As String = vbDblQuote, Optional ByVal EscapeChar As String = "\", Optional ByVal WithQuotes As Boolean = False) As String
        ...
        ''' <remarks></remarks>
        Public Function BatchParse(ByVal Scan As String, ByVal Separator As String, Optional ByVal SkipQuote As Boolean = False, Optional ByVal Unescape As Boolean = False, Optional ByVal QuoteChar As Char = """"c, Optional ByVal EscapeChar As Char = "\"c, Optional WithToken As Boolean = False, Optional WithTokenIn As Boolean = False, Optional ByVal Unquote As Boolean = False) As String()
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function PrintFriendlySize(ByVal size As ULong, Optional format As String = Nothing, Optional factor As FriendlyKBType = FriendlyKBType.Kilo1024, Optional printKi As Boolean = True) As String
            Dim fs As Double,
            nom As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function PrintFriendlySpeed(ByVal speed As ULong, Optional format As String = Nothing, Optional factor As FriendlyKBType = FriendlyKBType.Auto, Optional asBits As Boolean = True) As String
            Dim fs As Double,
            nom As String
