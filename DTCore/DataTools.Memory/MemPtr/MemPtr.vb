...
#Region "Manually-Called Memory Functions"
        ...
        ''' <remarks></remarks>
        Public Sub ZeroMemory(Optional ByVal index As Long = -1, Optional ByVal length As Long = -1)
        ...
        ''' <remarks></remarks>
        Public Function Alloc(size As Long, Optional addPressure As Boolean = False, Optional hHeap As IntPtr? = Nothing, Optional ByVal zeroMem As Boolean = True) As Boolean
            Dim l As Long = Length()
